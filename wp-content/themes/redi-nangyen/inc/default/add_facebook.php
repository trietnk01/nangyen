...
<div id="ja-fb-comments" class="fb-comments fb_iframe_widget fb_iframe_widget_fluid" data-width="100%" data-colorscheme="dark" data-numposts="10" data-href="<?php echo $link; ?>" fb-xfbml-state="rendered"></div>
