	...
	public function showPagination(){		
		...
		if($this->totalPage > 1){
			...
			if($this->currentPage > 1){
				$start 	= '<li ><a href="?trang=1&sortname='.$sortvalue.'"><i class="fa fa-angle-double-left" aria-hidden="true"></i></a></li>';
				$prev 	= '<li ><a href="?trang='.($this->currentPage-1).'&sortname='.$sortvalue.'"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li>';
			}
			...
			if($this->currentPage < $this->totalPage){
				$next 	= '<li ><a href="?trang='.($this->currentPage+1).'&sortname='.$sortvalue.'"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>';
				$end 	= '<li ><a href="?trang='.$this->totalPage.'&sortname='.$sortvalue.'" ><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>';
			}
			...
			for($i = $startPage; $i <= $endPage; $i++){
				if($i == $this->currentPage) {
					...
					$listPages .= '<li><a href="?trang='.$i.'&sortname='.$sortvalue.'">'.$i.'</a></li>';
				}
			}
			$listPages .= '';
